...
<body class="p10">  
  <form  name="form1" action=""  method="post" >  
 	...
 	<table align="center" border="0" cellpadding="0" cellspacing="0" width="100%">
		<tbody>
		 	<tr>
		 		<td class="title2" > <img src="../images/tb.gif" height="14" width="14" class="ico">分类信息维护</td>
		 	</tr>
		</tbody>
 	</table>
	<div style="margin-top: 8px"></div>
		<table  border="0" cellpadding="0" cellspacing="1" width="100%" class="table2">
			<tbody>
				<tr>
					<td align="right" width="100">所属一级分类</td>
					<td><label >${param.cateName }</label></td>
				</tr>
				<tr>
					<td align="right">分类名称</td>
					<td>
						<input style="margin-left: 15px" type="text" name="cateName" id="cateName" value='${param.cateName }' />
