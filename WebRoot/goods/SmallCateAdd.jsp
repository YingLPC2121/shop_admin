...
<%
 ...
 %>
  ...
  <form  name="form1" action="addSmallCate.do?flag=addSmallCate"  method="post" onsubmit="return validateInput()">
  	<table align="center" border="0" cellpadding="0" cellspacing="0" width="100%">
	 	<tr><td class="title2" > <img src="images/tb.gif" height="14" width="14" class="ico">添加二级分类</td></tr>
 	</table>
  	<div style="margin-top: 8px"></div>
  	<table  border="0" cellpadding="0" cellspacing="1" width="100%" class="table2">
  		<tbody>
  			<tr><td align="right" width="100">所属一级分类：</td>
  				<td>
			...
			<tr><td align="right">二级分类名称：</td><td><input type="text" style="margin-left: 15px" name="cateName"  value='' /><label id="lblCateName">*</label></td></tr>
			<tr><td align="right">二级分类描述：</td><td><input type="text" style="margin-left: 15px" name="cateDes"  value='' /></td></tr>
