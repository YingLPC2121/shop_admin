...
<html>
  ...
  <body>
	 ...
	 <form action="roleAdd.do?flag=roleAdd" method="post"  onsubmit="return validateInput()">
		 <table class="edit_table" >
		 		<tr>
	 			 	<td class="td_info">角色名称:</td>	
	 			 	<td class="td_input_short"> 
	 			 		<input type="text" class="txtbox" id="roleName" name="roleName" onfocus="showInfo(this,'2-15位,非空白字符')" onblur="validateRoleName(this)" /> 
	 			 	</td>   
	 			 	<td>
